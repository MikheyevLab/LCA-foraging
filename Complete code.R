...
tre2 <- read.nexus("/Users/Manasee/OneDrive/Documents/Phylocom/redo/treenew.nexus") #Output from Phylomatic and FigTree
...
library(MCMCglmm)
coefdat <- read.csv("datafortree.csv")
modelcoef <- glm(foraged ~ Species_mean, data = coefdat, family = binomial(link = 'logit'))
summary(modelcoef)

>>>>>>> 88cac34e4df72299a7ae7396d1faee5d418d5ef8
